...
# Allowed Hosts & CSRF for Cloud Deployments (Render, Vercel, Custom Domains)
ALLOWED_HOSTS = [
...
# Database Configuration (Auto-detect DATABASE_URL from Render/Railway/Heroku)
